...
app = FastAPI()
# connect(db="students", host="localhost" , port =27017)
connect(db="students", host= "mongodb+srv://yahrena:yahrena123@cluster0.3vbqcsa.mongodb.net/?retryWrites=true&w=majority")
...
def login(form_data: OAuth2PasswordRequestForm = Depends()):
    ...
    if authenticate_user(username, password):
        access_token = create_access_token(
                        data={"sub":username}, expires_delta=timedelta(minutes=10)
        )
